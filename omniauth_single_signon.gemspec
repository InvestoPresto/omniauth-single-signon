...
require "omniauth_single_signon/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "omniauth_single_signon"
  s.version     = OmniauthSingleSignon::VERSION
  s.authors     = ["Sankara Narayanan", "Subhash Chandra"]
  s.email       = ["sankara.narayanan@investopresto.com", "TMaYaD+github@gmail.com"]
  s.homepage    = "https://github.com/InvestoPresto/omniauth_single_signon"
